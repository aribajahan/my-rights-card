...
export default function Hotlines() {
  return (
    <InfoPageLayout title="Hotlines & Resources">
          ...
          <div className="p-4 bg-card rounded-2xl shadow-card">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <a href="tel:1-844-363-1423" className="text-lg font-bold text-primary block">
                  1-844-363-1423
                </a>
          ...
          <div className="p-4 bg-card rounded-2xl shadow-card">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <a href="tel:1-209-757-3733" className="text-lg font-bold text-primary block">
                  1-209-757-3733
                </a>
              </div>
            </div>
          ...
          <div className="p-4 bg-card rounded-2xl shadow-card">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <a href="tel:1-866-347-2423" className="text-lg font-bold text-primary block">
                  1-866-347-2423
                </a>
                <a 
          ...
          <div className="p-4 bg-card rounded-2xl shadow-card">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <a href="tel:1-800-898-7180" className="text-lg font-bold text-primary block">
                  1-800-898-7180
                </a>
              </div>
            </div>
      ...
      <section>
        <h2>Find a Lawyer</h2>
        <div className="p-4 bg-coral/10 rounded-2xl mb-4">
          <div className="flex items-start gap-3">
